...
# Set up Streamlit
st.title("MBTA energy cast")
# st.write("")
st.markdown("<p style='font-size: 18px; font-weight: bold;'>Sustainable energy forecasting tool for MBTA URT system</p>", unsafe_allow_html=True)
...
with col1:
    ...
    col_label.markdown("<p style='font-size: 35px; font-weight: bold;'>Line</p>", unsafe_allow_html=True)
    col_trips.markdown("<p style='font-size: 35px; font-weight: bold;'>Number of Trips</p>", unsafe_allow_html=True)
    col_distance.markdown("<p style='font-size: 35px; font-weight: bold;'>Operating Distance (miles)</p>", unsafe_allow_html=True)
    col_speed.markdown("<p style='font-size: 35px; font-weight: bold;'>Average Speed (mph)</p>", unsafe_allow_html=True)
    ...
    for i, line in enumerate(lines):
        ...
        col_label.markdown(f"<p style='font-size: 18px; font-weight: bold;'>{line}</p>", unsafe_allow_html=True)
